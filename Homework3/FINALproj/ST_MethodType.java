...
public class ST_MethodType {
    ...
    public Map<String, String> retVarsMap() {
        return this.Variables;
    }

    public Map<String, String> retVarsClass() {
        return this.MethClassInstances;
    }
    ...
    public Boolean isClassInstVar(String Ident) {
        if (this.MethClassInstances.containsKey(Ident)) {
            return true;
        }
        return false;
    }
